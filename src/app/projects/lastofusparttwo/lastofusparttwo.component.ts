...
@Component({
  selector: 'app-lastofusparttwo',
  templateUrl: './lastofusparttwo.component.html',
  styleUrls: ['./lastofusparttwo.component.css']
})
export class LastofusparttwoComponent implements OnInit {
